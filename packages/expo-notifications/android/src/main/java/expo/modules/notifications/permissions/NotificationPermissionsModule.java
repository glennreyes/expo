...
public class NotificationPermissionsModule extends ExportedModule {
  ...
  private Bundle getPermissionsBundle() {
    ...
    boolean areEnabled = manager.areNotificationsEnabled();
    ...
    platformPermissions.putInt(IMPORTANCE_KEY, manager.getImportance());
    platformPermissions.putBundle(ANDROID_RESPONSE_KEY, platformPermissions);
